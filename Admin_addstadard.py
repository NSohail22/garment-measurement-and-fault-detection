...
class add_standrads:
    def __init__(self,root):
        ...
        title = Label(self.root, text="GARMENT MEASUREMENT & FAULT DETECTION SYSTEM",font=("times new roman",28,"bold"), bg="#5780B6", fg="white")
        title.place(x=0 , y=0, width=1366, height=90)
        back_btn = Button(self.root, text="Back", command=self.Back_Func, bg='#5780B6', font=("Goudy", 16, "bold"),bd=0, fg='white', cursor='hand2', activebackground='#32cf8e')
        back_btn.place(x=10, y=28)
        self.txt_logout = Button(self.root, text='Logout', command=self.Logout_Func, bg='#5780B6', font=("Goudy", 16, "bold"),bd=0, fg='white', cursor='hand2', activebackground='#32cf8e')
