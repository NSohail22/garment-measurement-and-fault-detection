...
class page_Scanning():
    ...
    # =====================================================================================================
        ...
        width_label = Label(details_frame, text="Width of Pant: %d cm"  %(waist_1),font=("Arial",22),fg='lightgray',bg='#5780B6')
        width_label.place(x=50, y=120)

        details_label = Label(details_frame, text="Length of Pant: %d cm" %(length_1) ,font=("Arial",22),fg='lightgray',bg='#5780B6')
        ...
        # details_dat = Label(details_frame, text="Remarks = Accepted", font=("Arial",22),fg='lightgray',bg='#5780B6')
        # details_dat.place(x=50, y=260)
